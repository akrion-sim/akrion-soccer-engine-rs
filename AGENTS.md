...
> **Note:** this repo is outmoded locally, use `~/codes/akrion-sim` instead for local editing.
> The training-deploy pipeline below still runs from the `ORESoftware` upstream.
