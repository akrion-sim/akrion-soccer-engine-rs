...

{
  ...
  post_claude "overnight full-stack proof launched: ${RUN_ID}. Will train NN+DP+MPC/pass-completion/pass-receiver/support/spacing candidate, eval vs fresh gen0, aggregate with c_pto/b_pto turnover guard, and report artifacts from ${OUT_DIR}."
  ...
  export DD_SOCCER_PASS_TURNOVER_PENALTY_SCALE="${DD_SOCCER_PASS_TURNOVER_PENALTY_SCALE:-6}"
  export SOCCER_OFFBALL_SUPPORT_REWARD_SCALE="${SOCCER_OFFBALL_SUPPORT_REWARD_SCALE:-2.5}"
