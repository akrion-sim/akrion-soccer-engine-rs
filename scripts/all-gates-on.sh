...
export SOCCER_LEAGUE_FIXED_ANALYTIC_TRAINING_ANCHOR="${SOCCER_LEAGUE_FIXED_ANALYTIC_TRAINING_ANCHOR:-true}"
export SOCCER_LEAGUE_ANALYTIC_ANCHOR_GATE="${SOCCER_LEAGUE_ANALYTIC_ANCHOR_GATE:-true}"
export SOCCER_LEAGUE_ANALYTIC_ANCHOR_VALIDATE_GAMES="${SOCCER_LEAGUE_ANALYTIC_ANCHOR_VALIDATE_GAMES:-8}"
export SOCCER_LEAGUE_ANALYTIC_ANCHOR_MAX_GOAL_DIFF_REGRESSION="${SOCCER_LEAGUE_ANALYTIC_ANCHOR_MAX_GOAL_DIFF_REGRESSION:-0.0}"
export SOCCER_ANCHOR_PROMOTION_GATE_ENABLED=true
export SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_NON_REGRESSION="${SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_NON_REGRESSION:-true}"
export SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_GAMES="${SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_GAMES:-4}"
export SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_MAX_GOAL_DIFF_REGRESSION="${SOCCER_ANCHOR_PROMOTION_GATE_ANALYTIC_MAX_GOAL_DIFF_REGRESSION:-0.0}"
...
export DD_SOCCER_ENABLE_MINIBATCHED_MAPPO=true
export SOCCER_MAPPO_ACTOR_LEARNING_RATE="${SOCCER_MAPPO_ACTOR_LEARNING_RATE:-0.0003}"
export SOCCER_MAPPO_MINIBATCH_SIZE="${SOCCER_MAPPO_MINIBATCH_SIZE:-1024}"
