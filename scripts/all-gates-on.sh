...
export DD_SOCCER_ENABLE_DEFERRED_PASS_CREDIT=true
export DD_SOCCER_QUICK_FORWARD_RELEASE_REWARD_SCALE=1.0
...
export SOCCER_LEAGUE_ANALYTIC_OPPONENTS=true
...
export SOCCER_NEURAL_MCTS_ENABLED=false
export SOCCER_LEAGUE_NEURAL_MCTS_ENABLED=false
export SOCCER_NEURAL_MCTS_CANDIDATES=8
export SOCCER_NEURAL_MCTS_PASS_TARGET_CANDIDATES=8
