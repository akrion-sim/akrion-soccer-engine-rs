...
def decision_examples():
    ...
    exs.append({
        ...
        "story": "The neural net likes a through-ball; the DP/Q prior (from replayed outcomes) "
                 "agrees it creates the most value, nudging the blend. The policy still samples "
                 "the switch and the carry sometimes.",
        "phase": "onball", "prior_w": prior_w,
        "neural": [0.6, 1.9, 1.4, 2.2, 0.7, 1.6, 0.3, -0.4, -2.0, 0,0,0,0,0,0,0],
        "prior":  [0.2, 0.4, 0.3, 1.1, 0.1, 0.5, 0.0, -0.3, -1.0, 0,0,0,0,0,0,0],
        "mask": onmask(),
    })
    exs.append({
