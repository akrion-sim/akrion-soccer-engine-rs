...
// KEY off-ball run rewards — kept SMALL so they only refine v3's proven attacking
// behavior and can't become a "stand ahead of the ball in a clear lane" farm.
...
const W_STAND_PEN: f32 = 0.03; // ANTI-PASSIVITY: an off-ball player shouldn't freeze to farm shaping
